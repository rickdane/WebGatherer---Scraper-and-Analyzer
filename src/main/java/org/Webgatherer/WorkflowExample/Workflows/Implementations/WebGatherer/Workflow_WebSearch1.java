...
public class Workflow_WebSearch1 extends WorkflowBase {
    ...
    public void runWorkflow(Map<String, Object> workflowParams) {
        ...
        //TODO work out Selenium issues so this isn't necessary
        //we aren't using the default driver provided due to a bug so just close it
//        WebDriver tempDriver = webGather.getDriver();
//        boolean isDestroyed = false;
//        if (!isDestroyed && tempDriver != null) {
//            tempDriver.close();
//            isDestroyed = true;
//        }
