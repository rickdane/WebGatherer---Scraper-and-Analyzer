...
import org.Webgatherer.Core.Threadable.Base.BaseWebThreadImpl;
...
public class WebGatherImpl extends BaseWebThreadImpl implements WebGather {
    ...
    public void retrievePageFromUrl(String url) {
        driver.get(url);
        threadCommunication.addToOutputDataHolder(driver.getPageSource());
    }
